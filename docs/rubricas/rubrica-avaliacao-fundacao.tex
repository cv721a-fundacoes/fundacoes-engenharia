...
{\large ML - BIM - Digital Twin como ferramentas de apoio}\\[0.2cm]
...
\subsection*{2. Projeto Gráfico (20\%)}
...
\noindent \textbf{Observação:} modelos complexos sem justificativa não geram nota adicional.
...
Uso do pyRevit & Funcional e justificado \\
Rastreamento entre dados e modelo & Evidente \\
\bottomrule
\end{tabularx}
\end{center}

...
A adoção de ferramentas tecnológicas na disciplina segue os princípios:

- **Primazia do método clássico**: decisões técnicas devem ser fundamentadas em normas e critérios consagrados.
- **Tecnologia como apoio**: Machine Learning, BIM e scripts são ferramentas auxiliares.
- **Simplicidade consciente**: modelos computacionais devem ser compreendidos, não apenas executados.
- **Reprodutibilidade**: todos os exemplos e datasets utilizados são versionados neste repositório.
...
**Recursos:**
- Pasta `datasets/`
- Notebooks introdutórios em `notebooks/`
...
- Discussão crítica de erros, limitações e incertezas.

**Recursos:**
- Notebooks de projeto em `notebooks/`
- Exemplos resolvidos em `exemplos/`
...
- `docs/`: documentos institucionais e pedagógicos da disciplina.
- `datasets/`: conjuntos de dados utilizados na trilha tecnológica.
- `notebooks/`: notebooks computacionais da disciplina.
- `exemplos/`: exemplos didáticos resolvidos.
- `templates/`: modelos de relatórios e notebooks-base.

---

## 5. Considerações Finais

A trilha tecnológica foi concebida para **ampliar a formação do engenheiro civil**, preservando o rigor técnico da Engenharia Geotécnica e introduzindo, de forma responsável, ferramentas digitais contemporâneas.

O domínio dos conceitos fundamentais permanece soberano em todas as etapas da disciplina.
...
Será fornecido um dataset-base oficial da disciplina. Cada grupo deverá utilizar
obrigatoriamente um modelo de regressão linear e, opcionalmente, um segundo modelo
simples. Os resultados obtidos por meio de Machine Learning deverão ser comparados
criticamente com aqueles provenientes do dimensionamento clássico.

A aplicação de Machine Learning no Projeto~1 será realizada por meio de uma ferramenta
visual de caráter didático (Orange), com o objetivo de introduzir conceitos fundamentais
de aprendizagem supervisionada, avaliação de erro e análise comparativa entre métodos.
O uso da ferramenta não substitui o raciocínio de engenharia, o dimensionamento
normativo ou o julgamento técnico do projetista.

...
do curso de Engenharia Civil da UNICAMP.

Aqui estão organizados os **enunciados dos projetos**, **rubricas de avaliação**, 
**datasets**, **notebooks-base** e materiais de apoio à aplicação de ferramentas
computacionais, sempre **subordinadas ao raciocínio clássico da Engenharia Geotécnica**.
...
- `exemplos/`  
  Exemplos simples e comentados, exclusivamente para fins didáticos.
...
- Cada grupo deverá criar **seu próprio repositório**, conforme orientações fornecidas em aula.
- Não é avaliada a complexidade de programação, mas sim:
  - organização,
  - clareza,
  - coerência técnica.
